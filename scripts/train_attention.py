"""
Training script for Attention model
"""
...
def main():
    ...
    model = create_model('attention', vocab_size=len(vocab))
    ...
    with open('results/attention_history.json', 'w') as f:
    ...
    print("\nTraining complete!")
    print(f"Best model saved to: checkpoints/best_attention.pth")
    print(f"Results saved to: results/attention_results.json")
