...
def main():
    ...
    model = create_model('transformer', vocab_size=len(vocab))
    ...
    print("\nTraining complete!")
    print(f"Best model saved to: checkpoints/best_transformer.pth")
    print(f"Results saved to: results/transformer_results.json")
